        ...
        <View>
          <Pressable onPress={() => alert('Component Pressed')}>
            <Text>
              ...
              voluptas, quod, voluptates, incidunt, autem quas quae quia
              repudiandae quibusdam ipsa doloremque. Quisquam voluptas, quod,
              voluptates, incidunt, autem quas quae quia repudiandae quibusdam
              ipsa doloremque.
            </Text>
          </Pressable>
        </View>
